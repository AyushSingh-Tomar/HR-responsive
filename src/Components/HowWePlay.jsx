...
const HowWePlay = () => {
  return (
    <div className="mt-[2vw] relative px-4 sm:px-6" style={{ fontFamily: 'Poppins, sans-serif' }}>
      <h2 className='bg-[#006699] ml-[5vw] text-xl sm:text-[2vw] pl-[4vw] text-white relative z-10 flex items-center h-[3vw] sm:h-[5vh] text-center sm:text-left' style={{ fontFamily: "Poppins, sans-serif" }}>
        How we play ?
      </h2>
      <br />
      <br />

      <div className="flex flex-wrap justify-center gap-4 p-2 mt-5 relative sm:justify-between" style={{ fontFamily: 'Poppins, sans-serif' }}>
        {[
          ...
          <div 
            key={index} 
            className={`min-h-[250px] flex flex-col justify-between w-full sm:w-auto sm:min-h-[300px] ${index !== 0 ? 'sm:-ml-[30px]' : ''}`} 
      ...
      <br />
      <br />
      <div className="absolute bottom-[-1.5vw] right-[1.5vw] sm:bottom-[-3vw] sm:right-[2vw]">
        <img src={logo2} className="h-[5vw] sm:h-[4vw]" alt="Company Logo" />
      </div>
    </div>
  );
};
