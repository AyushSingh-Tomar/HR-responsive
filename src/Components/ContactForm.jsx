  ...
  return (
    <>
      <div className={`w-[90%] mx-auto p-6 rounded-lg mt-4 ${isMobile ? '' : 'w-[80%]'}`} style={{ backgroundColor: "#fff", fontFamily: "Poppins, sans-serif" }}>
        ...
        <div className={`flex ${isMobile ? 'flex-col' : 'flex-row'} justify-between mb-4  border-4 border-gray-300 p-4 rounded-lg `}>
...
<div className="p-4 bg-white w-full md:w-[60%] border border-blue-400 overflow-hidden break-words">
  ...
  <div className="w-full flex flex-col md:grid md:grid-cols-2 gap-4 mb-4 border-4 border-gray-300 p-4 rounded-lg">
